...
import my.coreapp.rest.dto.PointerToBadgeLinkDTO;
...
@RestController
@RequestMapping("/neocloud4j/online/v1/secured/api/pointer/manytomany/Badge")
public class PointerToBadgeServiceFacade {
    ...
    public Serializable createLink(@RequestParam("roleAId") RestObjectFullId roleAId,
        ...
        service.createLink((Pointer) roleAId.getPersistable(), (Badge) roleBId.getPersistable(), container);
        return result;
    }
    ...
    public Serializable deleteLink(@RequestParam("roleAId") RestObjectFullId roleAId,
        ...
        Pointer roleA = (Pointer) roleAId.getPersistable();
        Badge roleB = (Badge) roleBId.getPersistable();
    ...
    public Serializable moveFromRoleA(@RequestParam("roleAId") RestObjectFullId roleAId,
        ...
        Pointer roleA = (Pointer) roleAId.getPersistable();
        Pointer targetRoleA = (Pointer) targetRoleAId.getPersistable();
        Badge roleB = (Badge) roleBId.getPersistable();
    ...
    public Serializable getLink(@RequestParam("roleAId") RestObjectFullId roleAId,
        ...
        Pointer roleA = (Pointer) roleAId.getPersistable();
        Badge roleB = (Badge) roleBId.getPersistable();
        Optional<PointerToBadgeLink> linkAsOptional = service.getLink(roleA, roleB, container);
    ...
    public Serializable getAllRoleBs(@RequestParam("roleAId") RestObjectFullId roleAId,
        ...
        Pointer roleA = (Pointer) roleAId.getPersistable();
        List<Badge> roleBs = service.getAllRoleBs(roleA, container);
    ...
    public Serializable getAllPointerInverseRoleBsManyToManyLinkToOfBadge(
                                     @RequestParam("roleBId") RestObjectFullId roleBId,
                                     @RequestParam("containerId") Container container){

        Badge roleB = (Badge) roleBId.getPersistable();
        List<Pointer> roleAs = service.getAllPointerInverseRoleBsManyToManyLinkToOfBadge(roleB, container);
    ...
    public Serializable getAllRoleBsWithLink(@RequestParam("roleAId") RestObjectFullId roleAId,
        ...
        Pointer roleA = (Pointer) roleAId.getPersistable();
        Map<Badge, PointerToBadgeLink> links = service.getAllRoleBsWithLink(roleA, container);
        List dtos = links.keySet().stream().map(key -> PointerToBadgeLinkDTO.from(key, links.get(key))).collect(Collectors.toList());
        result.setData(dtos);
        return result;
    }
